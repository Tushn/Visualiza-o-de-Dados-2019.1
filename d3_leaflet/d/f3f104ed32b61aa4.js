...
hourDim.group()
  ...
  main.variable(observer("buildvis")).define("buildvis", ["md","container","dc","magnitudeDim","d3","magnitudeGroup","depthDim","depthGroup","dataset","hourDim","hourGroup","dateDim"], function(md,container,dc,magnitudeDim,d3,magnitudeGroup,depthDim,depthGroup,dataset,hourDim,hourGroup,dateDim)
{
  let view = md`${container('dc-table-graph', 'Tabela de terremotos')}`
  
  let dataTable = dc.dataTable(view.querySelector("#dc-table-graph"))
  let barMagnitudeChart = dc.barChart(view.querySelector("#magnitude-chart"))
  let barDepthChart = dc.barChart(view.querySelector("#depth-chart"))
  let lineChart = dc.lineChart(view.querySelector("#time-chart"))
  barMagnitudeChart.width(480)
          .height(150)          
